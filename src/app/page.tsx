...
const features: readonly Feature[] = [
  ...
  },
  {
    ...
    title: "AIチャット",
    description:
      "保存した知識ベースについてAIに質問。あなたの第二の脳と対話。",
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="faq"
        className="scroll-mt-20 bg-gray-50/50 py-24 sm:py-32"
      >
